...
module top_draw (
  ...
  bram_if #(
      .ADDR_WIDTH($clog2(STATUS_TITLE_LEN + 1)),
      .DATA_WIDTH(8),
      .READ_ONLY (1)
  ) status_lbl_bram ();
  bram_if #(
  ...
  bram_if #(
      .ADDR_WIDTH($clog2(STATUS_LIGHT_LEN + 1)),
      .DATA_WIDTH(8),
      .READ_ONLY (1)
  ) light_bram ();
  bram_if #(
  ...
  bram_if #(
      .ADDR_WIDTH($clog2(STATUS_OS_LEN + 1)),
      .DATA_WIDTH(8),
      .READ_ONLY (1)
  ) os_bram ();
  bram_if #(
  ...
  bram_if #(
      .ADDR_WIDTH($clog2(CONSOLE_TITLE_LEN + 1)),
      .DATA_WIDTH(8),
      .READ_ONLY (1)
  ) console_title_bram ();
  ...
  string_rom u_string_rom (
      ...
      .status_lbl_bram(status_lbl_bram),
      .link_bram(link_bram),
      ...
      .console_title_bram(console_title_bram)
  );
  ...
  // =========================================================================
  localparam int NUM_DRAW_ELEMENTS = 43;
  ...
  // Line 2: Optical Light Detection (Light Detect / No Light)
  draw_string #(
      .FONT(FONT_11x7),
      .FONT_PATH(FONT_11x7_PATH),
      .MAX_STRING_LEN(STATUS_LIGHT_LEN + 1),
      .COLOR(COLOR_STATUS_LIGHT_ON)
  ) u_draw_status_light (
      .clk(clk),
      .rst_n(rst_n),
      .vga_in(vga_in),
  ...
  assign draw_rgb[13] = rx_carrier ? COLOR_STATUS_LIGHT_ON : COLOR_STATUS_LIGHT_OFF;
  ...
  // Line 4: Oversampling (8x / 16x)
  draw_string #(
      .FONT(FONT_11x7),
      .FONT_PATH(FONT_11x7_PATH),
      .MAX_STRING_LEN(STATUS_OS_LEN + 1),
      .COLOR(COLOR_STATUS_OS)
  ) u_draw_status_os (
      .clk(clk),
      .rst_n(rst_n),
      .vga_in(vga_in),
  ...
  // =========================================================================
  // [17] STATUS CARD TITLE LABEL (ABOVE STATUS BOX)
  // =========================================================================
  draw_string #(
      .FONT(FONT_11x7),
      .FONT_PATH(FONT_11x7_PATH),
      .MAX_STRING_LEN(STATUS_TITLE_LEN),
      .COLOR(COLOR_STATUS_TITLE)
  ) u_draw_status_lbl (
      .clk(clk),
      .rst_n(rst_n),
      .vga_in(vga_in),
      ...
      .letter_spacing(8'd1),
      .row_spacing(8'd1),
      .pixel_color(draw_rgb[17]),
      .draw_en(draw_en[17])
  );

  // =========================================================================
  // [18] DIAGNOSTICS CARD TITLE LABEL (ABOVE DIAGNOSTICS BOX)
  // =========================================================================
  draw_string #(
      .FONT(FONT_11x7),
      .FONT_PATH(FONT_11x7_PATH),
  ...
  // =========================================================================
  // [19..26] DIAGNOSTICS LABELS & METERS (INSIDE SHORTER BOX)
  // =========================================================================
  draw_string #(
      .FONT(FONT_11x7),
      .FONT_PATH(FONT_11x7_PATH),
  ...
  // =========================================================================
  // [28] CONSOLE LABEL (ABOVE CONSOLE BOX, ALIGNED WITH DYNAMIC BITMAP AT y=135)
  // =========================================================================
  draw_string #(
      .FONT(FONT_11x7),
      .FONT_PATH(FONT_11x7_PATH),
      .MAX_STRING_LEN(CONSOLE_TITLE_LEN),
      .COLOR(12'hF_F_8)
  ) u_draw_console_lbl (
      .clk(clk),
      .rst_n(rst_n),
  ...
  // =========================================================================
  // [29..30] CONSOLE FRAME & SOLID BACKGROUND
  // =========================================================================
  ...
  // =========================================================================
  // [33..34] DYNAMIC BITMAP FRAME & CANVAS BACKGROUND
  // =========================================================================
  ...
  // =========================================================================
  // [35..36] STATUS CARD FRAME & BACKGROUND
  // =========================================================================
  ...
  // =========================================================================
  // [37..38] DIAGNOSTICS CARD FRAME & BACKGROUND (SHORTER: y=325..700)
  // =========================================================================
  ...
  // =========================================================================
  // [39..40] TOP HEADER BAR BORDER & BACKGROUND
  // =========================================================================
